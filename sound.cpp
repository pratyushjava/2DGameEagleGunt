  ...
  channels() 
{
  ...
  music = Mix_LoadMUS("sound/Marimba_Boy.wav");
  // Need to install midi to play the following:
  // music = Mix_LoadMUS("sound/Marimba_Boy");
  if (!music) throw string("Couldn't Marimba_Boy.wav")+Mix_GetError();
  ...
  sounds.push_back( Mix_LoadWAV("sound/Caw.wav") );
