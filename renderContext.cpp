...
RenderContext::RenderContext() : 
	...
	WIDTH(gamedata.getXmlInt("window/width")), 
  HEIGHT(gamedata.getXmlInt("window/height")),
	window(nullptr), renderer(nullptr)  ,factory(FrameFactory::getInstance())
{
...
SDL_Window* RenderContext::initWindow( ) {
	window = SDL_CreateWindow( "2D Game Development", SDL_WINDOWPOS_CENTERED, 
